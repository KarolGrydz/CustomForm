...
export const passwordInfo = document.querySelector('.password span');
export const messageBox = document.querySelector('textarea');
export const messageInfo = document.querySelector('.message span');
export const specjalCharacters = [
  '!',
  '@',
  '#',
  '$',
